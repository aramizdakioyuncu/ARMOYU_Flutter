            ...
            flexibleSpace: FlexibleSpaceBar(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  CachedNetworkImage(
                                    imageUrl: controller
                                        .cafe.value!.logo.mediaURL.minURL.value,
                                    height: 60,
                                    fit: BoxFit.cover,
                                  ),
                                  const SizedBox(
              ...
              background: GestureDetector(
                child: CachedNetworkImage(
                  imageUrl: controller.cafe.value!.banner.mediaURL.minURL.value,
                  fit: BoxFit.cover,
                ),
              ),
            ),
                    ...
                    : SliverPadding(
                        ...
                        sliver: SliverGrid(
                          ...
                          delegate: SliverChildBuilderDelegate(
                                  ...
                                  child: Column(
                                    children: [
                                      SizedBox(
                                        ...
                                        child: Image.network(
                                          controller.cafe.value!.products[index]
                                              .logo.mediaURL.minURL.value,
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                            ...
                            childCount: controller.cafe.value!.products.length,
                          ),
                        ),
                      ),
          ),
