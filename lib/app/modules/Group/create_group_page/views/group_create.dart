          ...
          children: [
                  ...
                  CupertinoPicker(
                    ...
                    onSelectedItemChanged: (int selectedItem) async {
                      ...
                      Timer(const Duration(milliseconds: 700), () async {
                        if (controller.selectedcupertinolist.value.toString() !=
                    ...
                    children: List<Widget>.generate(
                      ...
                      return Center(
                        child: Text(
                          controller.cupertinolist[index]["value"].toString(),
                        ),
                      );
                    }),
                  ),
            ...
            CupertinoButton(
              ...
              onPressed: () => controller.showDialog(
                CupertinoPicker(
                  ...
                  children: List<Widget>.generate(
                    ...
                    return Center(
                      child: Text(
                        controller.cupertinolist2[index]["value"].toString(),
                      ),
                    );
                  }),
                ),
              ...
              child: Container(
                ...
                child: Text(
                  controller
                      .cupertinolist2[controller.selectedcupertinolist2.value]
                          ["value"]
                      .toString(),
                  style: const TextStyle(
                    fontSize: 22.0,
            ...
            CupertinoButton(
              ...
              child: Container(
                ...
                child: Text(
                  controller
                      .cupertinolist3[controller.selectedcupertinolist3.value]
                          ["value"]
                      .toString(),
                  style: const TextStyle(
                    fontSize: 22.0,
