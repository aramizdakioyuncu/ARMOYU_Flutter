      ...
      body: Shimmer.fromColors(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ShimmerPlaceholder.bannerPlaceholder(),
                ShimmerPlaceholder.titlePlaceholder(width: double.infinity),
                const SizedBox(height: 16.0),
                ShimmerPlaceholder.contentPlaceholder(
                  lineType: ContentLineType.threeLines,
                ),
                const SizedBox(height: 16.0),
                ShimmerPlaceholder.titlePlaceholder(width: 200.0),
                const SizedBox(height: 16.0),
                ShimmerPlaceholder.contentPlaceholder(
                  lineType: ContentLineType.twoLines,
                ),
                const SizedBox(height: 16.0),
                ShimmerPlaceholder.titlePlaceholder(width: 200),
                const SizedBox(height: 16.0),
                ShimmerPlaceholder.contentPlaceholder(
                  lineType: ContentLineType.twoLines,
                ),
